...
export class MyMigration1707527790087 implements MigrationInterface {
    name = 'MyMigration1707527790087'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "likes" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL, "created_by" integer NOT NULL, "updated_at" TIMESTAMP NOT NULL, "updated_by" integer NOT NULL, "userId" integer, "threadsId" integer, CONSTRAINT "PK_a9323de3f8bced7539a794b4a37" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "threads" ("id" SERIAL NOT NULL, "content" character varying NOT NULL, "image" character varying NOT NULL, "number_of_replies" integer NOT NULL, "created_at" TIMESTAMP NOT NULL, "created_by" integer NOT NULL, "updated_at" TIMESTAMP NOT NULL, "updated_by" integer NOT NULL, "userId" integer, CONSTRAINT "PK_d8a74804c34fc3900502cd27275" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "replies" ("id" SERIAL NOT NULL, "content" character varying NOT NULL, "image" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL, "created_by" integer NOT NULL, "updated_at" TIMESTAMP NOT NULL, "updated_by" integer NOT NULL, "userId" integer, "threadsId" integer, CONSTRAINT "PK_08f619ebe431e27e9d206bea132" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "following" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL, "created_by" integer NOT NULL, "updated_at" TIMESTAMP NOT NULL, "updated_by" integer NOT NULL, "followerId" integer, "followingId" integer, CONSTRAINT "PK_c76c6e044bdf76ecf8bfb82a645" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "username" character varying NOT NULL, "full_name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "photo_profile" character varying NOT NULL, "bio" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL, "created_by" integer NOT NULL, "updated_at" TIMESTAMP NOT NULL, "updated_by" integer NOT NULL, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
